...
#define BUTTON_2_PORT       GPIO_PORTD
#define BUTTON_2_PIN        GPIO_PIN_3
#define BUTTON_3_PORT       GPIO_PORTD
...
#define LED_1_PORT          GPIO_PORTD
#define LED_1_PIN           GPIO_PIN_2
#define LED_2_PORT          GPIO_PORTD
#define LED_2_PIN           GPIO_PIN_2
#define LED_3_PORT          GPIO_PORTD
...
#define DEVICE_1_PORT        GPIO_PORTB
#define DEVICE_1_PIN         GPIO_PIN_4
#define DEVICE_2_PORT        GPIO_PORTB
#define DEVICE_2_PIN         GPIO_PIN_5
#define DEVICE_3_PORT        GPIO_PORTB
#define DEVICE_3_PIN         GPIO_PIN_4
#define DEVICE_4_PORT        GPIO_PORTB
#define DEVICE_4_PIN         GPIO_PIN_5
